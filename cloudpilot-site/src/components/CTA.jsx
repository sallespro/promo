  ...
  return (
    <section className="py-24 md:py-32 px-4 md:px-8">
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        <div className="relative glass-card rounded-3xl p-12 md:p-16 space-y-8">
          ...
          <p className="text-muted text-xl max-w-2xl mx-auto leading-relaxed">
            We only take on 3–5 new clients per quarter to ensure every engagement receives
            our full attention. Book your free strategy session today.
          </p>
